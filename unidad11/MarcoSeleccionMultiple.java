 ...
 private JList listaJListCopia; // lista en la que se van a copiar los nombres de los
 ...
 listaJListColores.setSelectionMode(
  ...
  add( new JScrollPane( listaJListColores ) ); // agrega lista con panel de
 ...
 listaJListCopia.setListData( listaJListColores.getSelectedValues() );
  ...
  listaJListCopia = new JList(); // crea lista para guardar nombres de colores
  ...
  } // fin del constructor de MarcoSeleccionM