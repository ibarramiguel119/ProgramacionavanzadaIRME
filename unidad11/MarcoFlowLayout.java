 // Fig. 11.39: MarcoFlowLayout.java
  ...
  {
  private JButton botonJButtonIzquierda; // botón para establecer la alineación a la

  private JButton botonJButtonCentro; // botón para establecer la alineación al centro
  private JButton botonJButtonDerecha; // botón para establecer la alineación a la
